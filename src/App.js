    ...
    <div className="App bg-indigo-950">
      ...
      <section className=" w-full min-h-screen flex flex-col relative overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between text-center md:text-left w-full flex-1 px-4 md:px-6 py-8 md:py-12 gap-8 md:gap-12 lg:gap-16 relative z-10 max-w-7xl mx-auto">
          ...
          <div className="flex-1 max-w-3xl lg:max-w-4xl">
            ...
            <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-medium text-gray-300 leading-relaxed">
              Web Developer & Aspiring Software Engineer — passionate about
        ...
        <div className="flex justify-center pb-20 mb-20 relative z-10">
          <a
            href="#projects"
            className="text-white hover:text-blue-300 transition-all duration-300 animate-bounce"
          >
            <svg
              className="w-8 h-8"
              fill="none"
      ...
      <section
        id="projects"
        className="max-w-7xl mx-auto min-h-screen flex flex-col gap-12 px-4 sm:px-6 md:px-8 py-20 z-0"
      >
          ...
          >
            ...
            <div className="project-content p-6">
              <div className="project-text-content">
                <h3 className="text-3xl font-bold font- text-white mb-2 pt-4">
                  Health Smart Holistic Health
                </h3>
                <p className="project-description font- text-white text-2xl">
                  AI-powered health platform with personalized wellness
                  resources and intelligent search.
                </p>
                <div className="flex flex-wrap gap-2 mb-4">
                  <span className="tech-tag px-4 py-2 border-2 border-white rounded-full text-lg text-white font-bold">
                    Gatsby
                  </span>
                  <span className="tech-tag px-4 py-2 border-2 border-white rounded-full text-lg text-white font-bold">
                    Node.js
              ...
              <div className="flex gap-4">
                <a
                  href="https://healthsmart-czbucfhzavfhdzfr.eastus2-01.azurewebsites.net/"
                  target="_blank"
          ...
          >
            ...
            <div className="project-content p-6">
              <div className="project-text-content">
                ...
                <p className="project-description font- text-white text-2xl">
                  Minecraft-themed recipe platform with crafting-style interface
              ...
              <div className="flex gap-4">
                <a
                  href="https://github.com/davidnoq/Foodcraft"
                  className="project-link px-6 py-3 bg-indigo-600 text-white text-lg font-bold rounded-lg hover:bg-gray-400 hover:text-black transition"
                >
                  GitHub
                </a>
              </div>
          ...
          >
            ...
            <div className="project-content p-6">
              <div className="project-text-content">
                ...
                <p className="project-description font- text-white text-2xl">
                  AI-powered technical interview platform with automated test
                  generation and instant grading.
                </p>
                <div className="flex flex-wrap gap-2 mb-4">
                  <span className="tech-tag px-4 py-2 border-2 border-white rounded-full text-lg text-white font-bold">
                    Next.js
              ...
              <div className="flex gap-4">
                <a
                  href="https://github.com/davidnoq/skillbit"
                  className="project-link px-6 py-3 bg-indigo-600 text-white text-lg font-bold rounded-lg hover:bg-gray-400 hover:text-black transition"
                >
                  GitHub
                </a>
                <a
                  href="https://skillbit-e6uk9k9na-tylerhaismans-projects.vercel.app/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="project-link px-6 py-3 bg-indigo-600 text-white text-lg font-bold rounded-lg hover:bg-blue-400 transition"
                >
          ...
          >
            ...
            <div className="project-content p-6">
              <div className="project-text-content">
                ...
                <p className="project-description font- text-white text-2xl">
                  Food truck marketplace with geospatial search, real-time
              ...
              <div className="flex gap-4">
                <a
                  href="https://github.com/davidnoq/Bitewheels"
                  className="project-link px-6 py-3 bg-indigo-600 text-white text-lg font-bold rounded-lg hover:bg-gray-400 hover:text-black transition"
                >
                  GitHub
                </a>
      ...
      <section className="w-full App min-h-screen bg-white py-32 border-b-2 border-black flex flex-col relative overflow-hidden">
        ...
        <img
          src={girlImage}
          alt="Girl"
          className="raw-photo raw-photo-1"
          loading="lazy"
        />
        ...
        <img
          src={meImage}
          alt="Me"
          className="raw-photo raw-photo-2"
          loading="lazy"
        />
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="text-center">
            <div className="flex flex-wrap justify-center gap-8">
              <a
                href="mailto:davidnoq15@gmail.com"
                className="tech-tag px-12 py-8 border-4 border-black rounded-full text-2xl text-black font-bold flex items-center gap-3"
              >
                <svg
                  className="w-6 h-6"
                  fill="currentColor"
              ...
              <a
                href="https://www.linkedin.com/in/davidjnoguera/"
                target="_blank"
                rel="noopener noreferrer"
                className="tech-tag px-12 py-8 border-4 border-black rounded-full text-2xl text-black font-bold flex items-center gap-3"
              >
              ...
              <a
                href="https://github.com/davidnoq"
                target="_blank"
                rel="noopener noreferrer"
                className="tech-tag px-12 py-8 border-4 border-black rounded-full text-2xl text-black font-bold flex items-center gap-3"
              >
              ...
              <a
                href="/davidnogueraresume.pdf"
                target="_blank"
                rel="noopener noreferrer"
                className="tech-tag px-12 py-8 border-4 border-black rounded-full text-2xl text-black font-bold"
              >
                View Resume
              </a>
            </div>
